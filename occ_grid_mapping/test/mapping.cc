...
int main ( int argc, char **argv )
{
    ...
    /***** 初始Topic *****/
    g_odom_suber = nh.subscribe ( "/ngeeann_av/odom", 1, odometryCallback );
    ros::Subscriber laser_suber = nh.subscribe ( "/laser/scan", 1, laserCallback );
    g_map_puber = nh.advertise<nav_msgs::OccupancyGrid> ( "/map", 1 );
